# Downloads
- Download the Al-Quran Bangla Translation epub file from [here](https://github.com/saadixl/Bangla-Quran-Ebook/blob/main/dist/Al-Quran%20Bangla%20Translation.epub).
- Download the Al-Quran English Translation epub file from [here](https://github.com/saadixl/Bangla-Quran-Ebook/blob/main/dist/Al-Quran%20English%20Translation.epub).
...
# How to generate?
- You need to have node.js in your machine first. Then pull this repo in your machine. Then from the root run `node src/generate-bangla-quran`. This should generate the `dist/bangla-quran.html`. I don't have epub generator yet. So for now I am using [https://convertio.co/html-epub/](https://convertio.co/html-epub/) to convert the HTML file to EPUB.
- Then for Kindle, I used [https://cloudconvert.com/epub-to-mobi](https://cloudconvert.com/epub-to-mobi) to convert into MOBI since Kindle can't render EPUB files. Insha Allah soon I will be adding my own EPUB & MOBI generator in this repo.
- [UPDATE] You can send epub to your kindle using Amazon's [Send to kindle] (https://www.amazon.com/sendtokindle) website.
